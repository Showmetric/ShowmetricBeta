        ...
        function createWidgetData(widget, widgetCharts, dateRange) {
            ...
            if (widget.widgetType == 'customFusion') {
                for (var charts in widgetCharts) {
                    if (widgetCharts[charts].type == 'line' || widgetCharts[charts].type == 'area' || widgetCharts[charts].type == 'reachVsImpressions' || widgetCharts[charts].type == 'engagedUsersReach' ||widgetCharts[charts].type == 'bar' || widgetCharts[charts].type == 'column' || (widgetCharts[charts].type == 'costPerActionType' && (widget.meta != undefined))) finalCharts.lineCharts.push(widgetCharts[charts]);
