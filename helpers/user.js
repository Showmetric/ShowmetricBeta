        ...
        if (err)
            ...
            User.update({email: req.userEmail}, {
                ...
                if (err) return res.status(500).json({error: 'Internal Server Error'});
                    ...
                    // HTML Version
                    userDetail.html= '<p style="align-content: center;font-weight: bold">Welcome to Datapoolt</p>' + '<br>' + '<div style="font-family: Helvetica,Arial,sans-serif">' + '<span>Dear </span>' + '' + '<span>' + userDetail.name + ',' + '</span>' +
                    ...
                    userDetail.subject="Reset your password";
